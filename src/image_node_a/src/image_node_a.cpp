//博客链接：http://blog.csdn.net/ding977921830/article/details/70168877
#include <ros/ros.h>
...
int main(int argc, char** argv)
{
  ...
  cv::Mat image = cv::imread("/home/sun/Dragon.png", CV_LOAD_IMAGE_COLOR);//chage the directory to your own filepath
  cv::waitKey(30);
